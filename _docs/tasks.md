...
- [ ] [#9 Implement the chore occurrence lifecycle and overdue handling](https://github.com/cgbarreto/choremate/issues/9)
- [ ] [#10 Record completion and distinguish planned from actual responsibility](https://github.com/cgbarreto/choremate/issues/10)
- [ ] [#11 Build the current-week workload dashboard](https://github.com/cgbarreto/choremate/issues/11)
- [ ] [#12 Preserve and display weekly workload history](https://github.com/cgbarreto/choremate/issues/12)
- [ ] [#13 Deliver responsive web interface for desktop and smartphone browsers](https://github.com/cgbarreto/choremate/issues/13)
- [ ] [#14 Verify MVP data integrity and restart persistence](https://github.com/cgbarreto/choremate/issues/14)
